...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:pi,depthTest:!1,depthWrite:!1})}function ky(i,e,t){const n=new Float32Array(Zi),s=new A(0,1,0);return new jn({name:"SphericalGaussianBlur",defines:{n:Zi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Io(),fragmentShader:`
		...
		`,blending:pi,depthTest:!1,depthWrite:!1})}function xd(){return new jn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Io(),fragmentShader:`
		...
		`,blending:pi,depthTest:!1,depthWrite:!1})}function vd(){return new jn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Io(),fragmentShader:`
	...
	`}class Ip extends qn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},s=[n,n,n,n,n,n];this.texture=new up(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
}`,wM=[new A(1,0,0),new A(-1,0,0),new A(0,1,0),new A(0,-1,0),new A(0,0,1),new A(0,0,-1)],RM=[new A(0,-1,0),new A(0,-1,0),new A(0,0,1),new A(0,0,-1),new A(0,-1,0),new A(0,-1,0)],Od=new Te,fr=new A,Rl=new A;function CM(i,e,t){let n=new Eo;const s=new ie,r=new ie,a=new _t,o=new l_,l=new c_,c={},h=t.maxTextureSize,u={[_i]:tn,[tn]:_i,[on]:on},d=new jn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ie},radius:{value:4}},vertexShader:EM,fragmentShader:AM}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const p=new Qe;p.setAttribute("position",new Tt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new rt(p,d),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=qa;let m=this.type;this.render=function(T,R,x){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||T.length===0)return;this.type===$m&&(De("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=qa);const w=i.getRenderTarget(),I=i.getActiveCubeFace(),P=i.getActiveMipmapLevel(),O=i.state;O.setBlending(pi),O.buffers.depth.getReversed()===!0?O.buffers.color.setClear(0,0,0,0):O.buffers.color.setClear(1,1,1,1),O.buffers.depth.setTest(!0),O.setScissorTest(!1);const q=m!==this.type;q&&R.traverse(function(F){F.material&&(Array.isArray(F.material)?F.material.forEach(N=>N.needsUpdate=!0):F.material.needsUpdate=!0)});for(let F=0,N=T.length;F<N;F++){const V=T[F],H=V.shadow;if(H===void 0){De("WebGLShadowMap:",V,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;s.copy(H.mapSize);const ne=H.getFrameExtents();s.multiply(ne),r.copy(H.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/ne.x),s.x=r.x*ne.x,H.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/ne.y),s.y=r.y*ne.y,H.mapSize.y=r.y));const ae=i.state.buffers.depth.getReversed();if(H.camera._reversedDepth=ae,H.map===null||q===!0){if(H.map!==null&&(H.map.depthTexture!==null&&(H.map.depthTexture.dispose(),H.map.depthTexture=null),H.map.dispose()),this.type===Sr){if(V.isPointLight){De("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}H.map=new qn(s.x,s.y,{format:ns,type:xi,minFilter:Mt,magFilter:Mt,generateMipmaps:!1}),H.map.texture.name=V.name+".shadowMap",H.map.depthTexture=new ks(s.x,s.y,vn),H.map.depthTexture.name=V.name+".shadowMapDepth",H.map.depthTexture.format=vi,H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=It,H.map.depthTexture.magFilter=It}else V.isPointLight?(H.map=new Ip(s.x),H.map.depthTexture=new b0(s.x,Yn)):(H.map=new qn(s.x,s.y),H.map.depthTexture=new ks(s.x,s.y,Yn)),H.map.depthTexture.name=V.name+".shadowMap",H.map.depthTexture.format=vi,this.type===qa?(H.map.depthTexture.compareFunction=ae?vh:xh,H.map.depthTexture.minFilter=Mt,H.map.depthTexture.magFilter=Mt):(H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=It,H.map.depthTexture.magFilter=It);H.camera.updateProjectionMatrix()}const _e=H.map.isWebGLCubeRenderTarget?6:1;for(let ve=0;ve<_e;ve++){if(H.map.isWebGLCubeRenderTarget)i.setRenderTarget(H.map,ve),i.clear();else{ve===0&&(i.setRenderTarget(H.map),i.clear());const Ce=H.getViewport(ve);a.set(r.x*Ce.x,r.y*Ce.y,r.x*Ce.z,r.y*Ce.w),O.viewport(a)}if(V.isPointLight){const Ce=H.camera,Ke=H.matrix,it=V.distance||Ce.far;it!==Ce.far&&(Ce.far=it,Ce.updateProjectionMatrix()),fr.setFromMatrixPosition(V.matrixWorld),Ce.position.copy(fr),Rl.copy(Ce.position),Rl.add(wM[ve]),Ce.up.copy(RM[ve]),Ce.lookAt(Rl),Ce.updateMatrixWorld(),Ke.makeTranslation(-fr.x,-fr.y,-fr.z),Od.multiplyMatrices(Ce.projectionMatrix,Ce.matrixWorldInverse),H._frustum.setFromProjectionMatrix(Od,Ce.coordinateSystem,Ce.reversedDepth)}else H.updateMatrices(V);n=H.getFrustum(),v(R,x,H.camera,V,this.type)}H.isPointLightShadow!==!0&&this.type===Sr&&y(H,x),H.needsUpdate=!1}m=this.type,g.needsUpdate=!1,i.setRenderTarget(w,I,P)};function y(T,R){const x=e.update(_);d.defines.VSM_SAMPLES!==T.blurSamples&&(d.defines.VSM_SAMPLES=T.blurSamples,f.defines.VSM_SAMPLES=T.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new qn(s.x,s.y,{format:ns,type:xi})),d.uniforms.shadow_pass.value=T.map.depthTexture,d.uniforms.resolution.value=T.mapSize,d.uniforms.radius.value=T.radius,i.setRenderTarget(T.mapPass),i.clear(),i.renderBufferDirect(R,null,x,d,_,null),f.uniforms.shadow_pass.value=T.mapPass.texture,f.uniforms.resolution.value=T.mapSize,f.uniforms.radius.value=T.radius,i.setRenderTarget(T.map),i.clear(),i.renderBufferDirect(R,null,x,f,_,null)}function M(T,R,x,w){let I=null;const P=x.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(P!==void 0)I=P;else if(I=x.isPointLight===!0?l:o,i.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const O=I.uuid,q=R.uuid;let F=c[O];F===void 0&&(F={},c[O]=F);let N=F[q];N===void 0&&(N=I.clone(),F[q]=N,R.addEventListener("dispose",C)),I=N}if(I.visible=R.visible,I.wireframe=R.wireframe,w===Sr?I.side=R.shadowSide!==null?R.shadowSide:R.side:I.side=R.shadowSide!==null?R.shadowSide:u[R.side],I.alphaMap=R.alphaMap,I.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,I.map=R.map,I.clipShadows=R.clipShadows,I.clippingPlanes=R.clippingPlanes,I.clipIntersection=R.clipIntersection,I.displacementMap=R.displacementMap,I.displacementScale=R.displacementScale,I.displacementBias=R.displacementBias,I.wireframeLinewidth=R.wireframeLinewidth,I.linewidth=R.linewidth,x.isPointLight===!0&&I.isMeshDistanceMaterial===!0){const O=i.properties.get(I);O.light=x}return I}function v(T,R,x,w,I){if(T.visible===!1)return;if(T.layers.test(R.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&I===Sr)&&(!T.frustumCulled||n.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,T.matrixWorld);const q=e.update(T),F=T.material;if(Array.isArray(F)){const N=q.groups;for(let V=0,H=N.length;V<H;V++){const ne=N[V],ae=F[ne.materialIndex];if(ae&&ae.visible){const _e=M(T,ae,w,I);T.onBeforeShadow(i,T,R,x,q,_e,ne),i.renderBufferDirect(x,null,q,_e,T,ne),T.onAfterShadow(i,T,R,x,q,_e,ne)}}}else if(F.visible){const N=M(T,F,w,I);T.onBeforeShadow(i,T,R,x,q,N,null),i.renderBufferDirect(x,null,q,N,T,null),T.onAfterShadow(i,T,R,x,q,N,null)}}const O=T.children;for(let q=0,F=O.length;q<F;q++)v(O[q],R,x,w,I)}function C(T){T.target.removeEventListener("dispose",C);for(const x in c){const w=c[x],I=T.target.uuid;I in w&&(w[I].dispose(),delete w[I])}}}function PM(i,e){function t(){let U=!1;const de=new _t;let Z=null;const be=new _t(0,0,0,0);return{setMask:function(ge){Z!==ge&&!U&&(i.colorMask(ge,ge,ge,ge),Z=ge)},setLocked:function(ge){U=ge},setClear:function(ge,re,Ne,Ye,Et){Et===!0&&(ge*=Ye,re*=Ye,Ne*=Ye),de.set(ge,re,Ne,Ye),be.equals(de)===!1&&(i.clearColor(ge,re,Ne,Ye),be.copy(de))},reset:function(){U=!1,Z=null,be.set(-1,0,0,0)}}}function n(){let U=!1,de=!1,Z=null,be=null,ge=null;return{setReversed:function(re){if(de!==re){const Ne=e.get("EXT_clip_control");re?Ne.clipControlEXT(Ne.LOWER_LEFT_EXT,Ne.ZERO_TO_ONE_EXT):Ne.clipControlEXT(Ne.LOWER_LEFT_EXT,Ne.NEGATIVE_ONE_TO_ONE_EXT),de=re;const Ye=ge;ge=null,this.setClear(Ye)}},getReversed:function(){return de},setTest:function(re){re?G(i.DEPTH_TEST):Y(i.DEPTH_TEST)},setMask:function(re){Z!==re&&!U&&(i.depthMask(re),Z=re)},setFunc:function(re){if(de&&(re=Ig[re]),be!==re){switch(re){case nc:i.depthFunc(i.NEVER);break;case ic:i.depthFunc(i.ALWAYS);break;case sc:i.depthFunc(i.LESS);break;case Us:i.depthFunc(i.LEQUAL);break;case rc:i.depthFunc(i.EQUAL);break;case ac:i.depthFunc(i.GEQUAL);break;case oc:i.depthFunc(i.GREATER);break;case lc:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}be=re}},setLocked:function(re){U=re},setClear:function(re){ge!==re&&(ge=re,de&&(re=1-re),i.clearDepth(re))},reset:function(){U=!1,Z=null,be=null,ge=null,de=!1}}}function s(){let U=!1,de=null,Z=null,be=null,ge=null,re=null,Ne=null,Ye=null,Et=null;return{setTest:function(dt){U||(dt?G(i.STENCIL_TEST):Y(i.STENCIL_TEST))},setMask:function(dt){de!==dt&&!U&&(i.stencilMask(dt),de=dt)},setFunc:function(dt,Jn,On){(Z!==dt||be!==Jn||ge!==On)&&(i.stencilFunc(dt,Jn,On),Z=dt,be=Jn,ge=On)},setOp:function(dt,Jn,On){(re!==dt||Ne!==Jn||Ye!==On)&&(i.stencilOp(dt,Jn,On),re=dt,Ne=Jn,Ye=On)},setLocked:function(dt){U=dt},setClear:function(dt){Et!==dt&&(i.clearStencil(dt),Et=dt)},reset:function(){U=!1,de=null,Z=null,be=null,ge=null,re=null,Ne=null,Ye=null,Et=null}}}const r=new t,a=new n,o=new s,l=new WeakMap,c=new WeakMap;let h={},u={},d={},f=new WeakMap,p=[],_=null,g=!1,m=null,y=null,M=null,v=null,C=null,T=null,R=null,x=new ke(0,0,0),w=0,I=!1,P=null,O=null,q=null,F=null,N=null;const V=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let H=!1,ne=0;const ae=i.getParameter(i.VERSION);ae.indexOf("WebGL")!==-1?(ne=parseFloat(/^WebGL (\d)/.exec(ae)[1]),H=ne>=1):ae.indexOf("OpenGL ES")!==-1&&(ne=parseFloat(/^OpenGL ES (\d)/.exec(ae)[1]),H=ne>=2);let _e=null,ve={};const Ce=i.getParameter(i.SCISSOR_BOX),Ke=i.getParameter(i.VIEWPORT),it=new _t().fromArray(Ce),Ge=new _t().fromArray(Ke);function D(U,de,Z,be){const ge=new Uint8Array(4),re=i.createTexture();i.bindTexture(U,re),i.texParameteri(U,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(U,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ne=0;Ne<Z;Ne++)U===i.TEXTURE_3D||U===i.TEXTURE_2D_ARRAY?i.texImage3D(de,0,i.RGBA,1,1,be,0,i.RGBA,i.UNSIGNED_BYTE,ge):i.texImage2D(de+Ne,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ge);return re}const B={};B[i.TEXTURE_2D]=D(i.TEXTURE_2D,i.TEXTURE_2D,1),B[i.TEXTURE_CUBE_MAP]=D(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),B[i.TEXTURE_2D_ARRAY]=D(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),B[i.TEXTURE_3D]=D(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),G(i.DEPTH_TEST),a.setFunc(Us),pe(!1),le(uu),G(i.CULL_FACE),te(pi);function G(U){h[U]!==!0&&(i.enable(U),h[U]=!0)}function Y(U){h[U]!==!1&&(i.disable(U),h[U]=!1)}function ce(U,de){return d[U]!==de?(i.bindFramebuffer(U,de),d[U]=de,U===i.DRAW_FRAMEBUFFER&&(d[i.FRAMEBUFFER]=de),U===i.FRAMEBUFFER&&(d[i.DRAW_FRAMEBUFFER]=de),!0):!1}function Re(U,de){let Z=p,be=!1;if(U){Z=f.get(de),Z===void 0&&(Z=[],f.set(de,Z));const ge=U.textures;if(Z.length!==ge.length||Z[0]!==i.COLOR_ATTACHMENT0){for(let re=0,Ne=ge.length;re<Ne;re++)Z[re]=i.COLOR_ATTACHMENT0+re;Z.length=ge.length,be=!0}}else Z[0]!==i.BACK&&(Z[0]=i.BACK,be=!0);be&&i.drawBuffers(Z)}function ze(U){return _!==U?(i.useProgram(U),_=U,!0):!1}const Pe={[$i]:i.FUNC_ADD,[Jm]:i.FUNC_SUBTRACT,[Qm]:i.FUNC_REVERSE_SUBTRACT};Pe[eg]=i.MIN,Pe[tg]=i.MAX;const $={[ng]:i.ZERO,[ig]:i.ONE,[sg]:i.SRC_COLOR,[ec]:i.SRC_ALPHA,[hg]:i.SRC_ALPHA_SATURATE,[lg]:i.DST_COLOR,[ag]:i.DST_ALPHA,[rg]:i.ONE_MINUS_SRC_COLOR,[tc]:i.ONE_MINUS_SRC_ALPHA,[cg]:i.ONE_MINUS_DST_COLOR,[og]:i.ONE_MINUS_DST_ALPHA,[ug]:i.CONSTANT_COLOR,[dg]:i.ONE_MINUS_CONSTANT_COLOR,[fg]:i.CONSTANT_ALPHA,[pg]:i.ONE_MINUS_CONSTANT_ALPHA};function te(U,de,Z,be,ge,re,Ne,Ye,Et,dt){if(U===pi){g===!0&&(Y(i.BLEND),g=!1);return}if(g===!1&&(G(i.BLEND),g=!0),U!==Zm){if(U!==m||dt!==I){if((y!==$i||C!==$i)&&(i.blendEquation(i.FUNC_ADD),y=$i,C=$i),dt)switch(U){case Ds:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ql:i.blendFunc(i.ONE,i.ONE);break;case du:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case fu:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Be("WebGLState: Invalid blending: ",U);break}else switch(U){case Ds:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ql:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case du:Be("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case fu:Be("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Be("WebGLState: Invalid blending: ",U);break}M=null,v=null,T=null,R=null,x.set(0,0,0),w=0,m=U,I=dt}return}ge=ge||de,re=re||Z,Ne=Ne||be,(de!==y||ge!==C)&&(i.blendEquationSeparate(Pe[de],Pe[ge]),y=de,C=ge),(Z!==M||be!==v||re!==T||Ne!==R)&&(i.blendFuncSeparate($[Z],$[be],$[re],$[Ne]),M=Z,v=be,T=re,R=Ne),(Ye.equals(x)===!1||Et!==w)&&(i.blendColor(Ye.r,Ye.g,Ye.b,Et),x.copy(Ye),w=Et),m=U,I=!1}function ee(U,de){U.side===on?Y(i.CULL_FACE):G(i.CULL_FACE);let Z=U.side===tn;de&&(Z=!Z),pe(Z),U.blending===Ds&&U.transparent===!1?te(pi):te(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),a.setFunc(U.depthFunc),a.setTest(U.depthTest),a.setMask(U.depthWrite),r.setMask(U.colorWrite);const be=U.stencilWrite;o.setTest(be),be&&(o.setMask(U.stencilWriteMask),o.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),o.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),L(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?G(i.SAMPLE_ALPHA_TO_COVERAGE):Y(i.SAMPLE_ALPHA_TO_COVERAGE)}function pe(U){P!==U&&(U?i.frontFace(i.CW):i.frontFace(i.CCW),P=U)}function le(U){U!==Ym?(G(i.CULL_FACE),U!==O&&(U===uu?i.cullFace(i.BACK):U===jm?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Y(i.CULL_FACE),O=U}function Fe(U){U!==q&&(H&&i.lineWidth(U),q=U)}function L(U,de,Z){U?(G(i.POLYGON_OFFSET_FILL),(F!==de||N!==Z)&&(F=de,N=Z,a.getReversed()&&(de=-de),i.polygonOffset(de,Z))):Y(i.POLYGON_OFFSET_FILL)}function We(U){U?G(i.SCISSOR_TEST):Y(i.SCISSOR_TEST)}function Le(U){U===void 0&&(U=i.TEXTURE0+V-1),_e!==U&&(i.activeTexture(U),_e=U)}function Ve(U,de,Z){Z===void 0&&(_e===null?Z=i.TEXTURE0+V-1:Z=_e);let be=ve[Z];be===void 0&&(be={type:void 0,texture:void 0},ve[Z]=be),(be.type!==U||be.texture!==de)&&(_e!==Z&&(i.activeTexture(Z),_e=Z),i.bindTexture(U,de||B[U]),be.type=U,be.texture=de)}function oe(){const U=ve[_e];U!==void 0&&U.type!==void 0&&(i.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function at(){try{i.compressedTexImage2D(...arguments)}catch(U){Be("WebGLState:",U)}}function E(){try{i.compressedTexImage3D(...arguments)}catch(U){Be("WebGLState:",U)}}function S(){try{i.texSubImage2D(...arguments)}catch(U){Be("WebGLState:",U)}}function z(){try{i.texSubImage3D(...arguments)}catch(U){Be("WebGLState:",U)}}function J(){try{i.compressedTexSubImage2D(...arguments)}catch(U){Be("WebGLState:",U)}}function se(){try{i.compressedTexSubImage3D(...arguments)}catch(U){Be("WebGLState:",U)}}function he(){try{i.texStorage2D(...arguments)}catch(U){Be("WebGLState:",U)}}function fe(){try{i.texStorage3D(...arguments)}catch(U){Be("WebGLState:",U)}}function j(){try{i.texImage2D(...arguments)}catch(U){Be("WebGLState:",U)}}function Q(){try{i.texImage3D(...arguments)}catch(U){Be("WebGLState:",U)}}function Me(U){return u[U]!==void 0?u[U]:i.getParameter(U)}function Ae(U,de){u[U]!==de&&(i.pixelStorei(U,de),u[U]=de)}function me(U){it.equals(U)===!1&&(i.scissor(U.x,U.y,U.z,U.w),it.copy(U))}function ue(U){Ge.equals(U)===!1&&(i.viewport(U.x,U.y,U.z,U.w),Ge.copy(U))}function Xe(U,de){let Z=c.get(de);Z===void 0&&(Z=new WeakMap,c.set(de,Z));let be=Z.get(U);be===void 0&&(be=i.getUniformBlockIndex(de,U.name),Z.set(U,be))}function $e(U,de){const be=c.get(de).get(U);l.get(de)!==be&&(i.uniformBlockBinding(de,be,U.__bindingPointIndex),l.set(de,be))}function ot(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),h={},u={},_e=null,ve={},d={},f=new WeakMap,p=[],_=null,g=!1,m=null,y=null,M=null,v=null,C=null,T=null,R=null,x=new ke(0,0,0),w=0,I=!1,P=null,O=null,q=null,F=null,N=null,it.set(0,0,i.canvas.width,i.canvas.height),Ge.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:G,disable:Y,bindFramebuffer:ce,drawBuffers:Re,useProgram:ze,setBlending:te,setMaterial:ee,setFlipSided:pe,setCullFace:le,setLineWidth:Fe,setPolygonOffset:L,setScissorTest:We,activeTexture:Le,bindTexture:Ve,unbindTexture:oe,compressedTexImage2D:at,compressedTexImage3D:E,texImage2D:j,texImage3D:Q,pixelStorei:Ae,getParameter:Me,updateUBOMapping:Xe,uniformBlockBinding:$e,texStorage2D:he,texStorage3D:fe,texSubImage2D:S,texSubImage3D:z,compressedTexSubImage2D:J,compressedTexSubImage3D:se,scissor:me,viewport:ue,reset:ot}}function LM(i,e,t,n,s,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new ie,h=new WeakMap,u=new Set;let d;const f=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(E,S){return p?new OffscreenCanvas(E,S):Br("canvas")}function g(E,S,z){let J=1;const se=at(E);if((se.width>z||se.height>z)&&(J=z/Math.max(se.width,se.height)),J<1)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap||typeof VideoFrame<"u"&&E instanceof VideoFrame){const he=Math.floor(J*se.width),fe=Math.floor(J*se.height);d===void 0&&(d=_(he,fe));const j=S?_(he,fe):d;return j.width=he,j.height=fe,j.getContext("2d").drawImage(E,0,0,he,fe),De("WebGLRenderer: Texture has been resized from ("+se.width+"x"+se.height+") to ("+he+"x"+fe+")."),j}else return"data"in E&&De("WebGLRenderer: Image in DataTexture is too big ("+se.width+"x"+se.height+")."),E;return E}function m(E){return E.generateMipmaps}function y(E){i.generateMipmap(E)}function M(E){return E.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:E.isWebGL3DRenderTarget?i.TEXTURE_3D:E.isWebGLArrayRenderTarget||E.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function v(E,S,z,J,se,he=!1){if(E!==null){if(i[E]!==void 0)return i[E];De("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let fe;J&&(fe=e.get("EXT_texture_norm16"),fe||De("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let j=S;if(S===i.RED&&(z===i.FLOAT&&(j=i.R32F),z===i.HALF_FLOAT&&(j=i.R16F),z===i.UNSIGNED_BYTE&&(j=i.R8),z===i.UNSIGNED_SHORT&&fe&&(j=fe.R16_EXT),z===i.SHORT&&fe&&(j=fe.R16_SNORM_EXT)),S===i.RED_INTEGER&&(z===i.UNSIGNED_BYTE&&(j=i.R8UI),z===i.UNSIGNED_SHORT&&(j=i.R16UI),z===i.UNSIGNED_INT&&(j=i.R32UI),z===i.BYTE&&(j=i.R8I),z===i.SHORT&&(j=i.R16I),z===i.INT&&(j=i.R32I)),S===i.RG&&(z===i.FLOAT&&(j=i.RG32F),z===i.HALF_FLOAT&&(j=i.RG16F),z===i.UNSIGNED_BYTE&&(j=i.RG8),z===i.UNSIGNED_SHORT&&fe&&(j=fe.RG16_EXT),z===i.SHORT&&fe&&(j=fe.RG16_SNORM_EXT)),S===i.RG_INTEGER&&(z===i.UNSIGNED_BYTE&&(j=i.RG8UI),z===i.UNSIGNED_SHORT&&(j=i.RG16UI),z===i.UNSIGNED_INT&&(j=i.RG32UI),z===i.BYTE&&(j=i.RG8I),z===i.SHORT&&(j=i.RG16I),z===i.INT&&(j=i.RG32I)),S===i.RGB_INTEGER&&(z===i.UNSIGNED_BYTE&&(j=i.RGB8UI),z===i.UNSIGNED_SHORT&&(j=i.RGB16UI),z===i.UNSIGNED_INT&&(j=i.RGB32UI),z===i.BYTE&&(j=i.RGB8I),z===i.SHORT&&(j=i.RGB16I),z===i.INT&&(j=i.RGB32I)),S===i.RGBA_INTEGER&&(z===i.UNSIGNED_BYTE&&(j=i.RGBA8UI),z===i.UNSIGNED_SHORT&&(j=i.RGBA16UI),z===i.UNSIGNED_INT&&(j=i.RGBA32UI),z===i.BYTE&&(j=i.RGBA8I),z===i.SHORT&&(j=i.RGBA16I),z===i.INT&&(j=i.RGBA32I)),S===i.RGB&&(z===i.UNSIGNED_SHORT&&fe&&(j=fe.RGB16_EXT),z===i.SHORT&&fe&&(j=fe.RGB16_SNORM_EXT),z===i.UNSIGNED_INT_5_9_9_9_REV&&(j=i.RGB9_E5),z===i.UNSIGNED_INT_10F_11F_11F_REV&&(j=i.R11F_G11F_B10F)),S===i.RGBA){const Q=he?so:nt.getTransfer(se);z===i.FLOAT&&(j=i.RGBA32F),z===i.HALF_FLOAT&&(j=i.RGBA16F),z===i.UNSIGNED_BYTE&&(j=Q===ct?i.SRGB8_ALPHA8:i.RGBA8),z===i.UNSIGNED_SHORT&&fe&&(j=fe.RGBA16_EXT),z===i.SHORT&&fe&&(j=fe.RGBA16_SNORM_EXT),z===i.UNSIGNED_SHORT_4_4_4_4&&(j=i.RGBA4),z===i.UNSIGNED_SHORT_5_5_5_1&&(j=i.RGB5_A1)}return(j===i.R16F||j===i.R32F||j===i.RG16F||j===i.RG32F||j===i.RGBA16F||j===i.RGBA32F)&&e.get("EXT_color_buffer_float"),j}function C(E,S){let z;return E?S===null||S===Yn||S===Nr?z=i.DEPTH24_STENCIL8:S===vn?z=i.DEPTH32F_STENCIL8:S===Ir&&(z=i.DEPTH24_STENCIL8,De("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):S===null||S===Yn||S===Nr?z=i.DEPTH_COMPONENT24:S===vn?z=i.DEPTH_COMPONENT32F:S===Ir&&(z=i.DEPTH_COMPONENT16),z}function T(E,S){return m(E)===!0||E.isFramebufferTexture&&E.minFilter!==It&&E.minFilter!==Mt?Math.log2(Math.max(S.width,S.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?S.mipmaps.length:1}function R(E){const S=E.target;S.removeEventListener("dispose",R),w(S),S.isVideoTexture&&h.delete(S),S.isHTMLTexture&&u.delete(S)}function x(E){const S=E.target;S.removeEventListener("dispose",x),P(S)}function w(E){const S=n.get(E);if(S.__webglInit===void 0)return;const z=E.source,J=f.get(z);if(J){const se=J[S.__cacheKey];se.usedTimes--,se.usedTimes===0&&I(E),Object.keys(J).length===0&&f.delete(z)}n.remove(E)}function I(E){const S=n.get(E);i.deleteTexture(S.__webglTexture);const z=E.source,J=f.get(z);delete J[S.__cacheKey],a.memory.textures--}function P(E){const S=n.get(E);if(E.depthTexture&&(E.depthTexture.dispose(),n.remove(E.depthTexture)),E.isWebGLCubeRenderTarget)for(let J=0;J<6;J++){if(Array.isArray(S.__webglFramebuffer[J]))for(let se=0;se<S.__webglFramebuffer[J].length;se++)i.deleteFramebuffer(S.__webglFramebuffer[J][se]);else i.deleteFramebuffer(S.__webglFramebuffer[J]);S.__webglDepthbuffer&&i.deleteRenderbuffer(S.__webglDepthbuffer[J])}else{if(Array.isArray(S.__webglFramebuffer))for(let J=0;J<S.__webglFramebuffer.length;J++)i.deleteFramebuffer(S.__webglFramebuffer[J]);else i.deleteFramebuffer(S.__webglFramebuffer);if(S.__webglDepthbuffer&&i.deleteRenderbuffer(S.__webglDepthbuffer),S.__webglMultisampledFramebuffer&&i.deleteFramebuffer(S.__webglMultisampledFramebuffer),S.__webglColorRenderbuffer)for(let J=0;J<S.__webglColorRenderbuffer.length;J++)S.__webglColorRenderbuffer[J]&&i.deleteRenderbuffer(S.__webglColorRenderbuffer[J]);S.__webglDepthRenderbuffer&&i.deleteRenderbuffer(S.__webglDepthRenderbuffer)}const z=E.textures;for(let J=0,se=z.length;J<se;J++){const he=n.get(z[J]);he.__webglTexture&&(i.deleteTexture(he.__webglTexture),a.memory.textures--),n.remove(z[J])}n.remove(E)}let O=0;function q(){O=0}function F(){return O}function N(E){O=E}function V(){const E=O;return E>=s.maxTextures&&De("WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+s.maxTextures),O+=1,E}function H(E){const S=[];return S.push(E.wrapS),S.push(E.wrapT),S.push(E.wrapR||0),S.push(E.magFilter),S.push(E.minFilter),S.push(E.anisotropy),S.push(E.internalFormat),S.push(E.format),S.push(E.type),S.push(E.generateMipmaps),S.push(E.premultiplyAlpha),S.push(E.flipY),S.push(E.unpackAlignment),S.push(E.colorSpace),S.join()}function ne(E,S){const z=n.get(E);if(E.isVideoTexture&&Ve(E),E.isRenderTargetTexture===!1&&E.isExternalTexture!==!0&&E.version>0&&z.__version!==E.version){const J=E.image;if(J===null)De("WebGLRenderer: Texture marked for update but no image data found.");else if(J.complete===!1)De("WebGLRenderer: Texture marked for update but image is incomplete");else{Y(z,E,S);return}}else E.isExternalTexture&&(z.__webglTexture=E.sourceTexture?E.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,z.__webglTexture,i.TEXTURE0+S)}function ae(E,S){const z=n.get(E);if(E.isRenderTargetTexture===!1&&E.version>0&&z.__version!==E.version){Y(z,E,S);return}else E.isExternalTexture&&(z.__webglTexture=E.sourceTexture?E.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,z.__webglTexture,i.TEXTURE0+S)}function _e(E,S){const z=n.get(E);if(E.isRenderTargetTexture===!1&&E.version>0&&z.__version!==E.version){Y(z,E,S);return}t.bindTexture(i.TEXTURE_3D,z.__webglTexture,i.TEXTURE0+S)}function ve(E,S){const z=n.get(E);if(E.isCubeDepthTexture!==!0&&E.version>0&&z.__version!==E.version){ce(z,E,S);return}t.bindTexture(i.TEXTURE_CUBE_MAP,z.__webglTexture,i.TEXTURE0+S)}const Ce={[Fs]:i.REPEAT,[Gn]:i.CLAMP_TO_EDGE,[to]:i.MIRRORED_REPEAT},Ke={[It]:i.NEAREST,[Kf]:i.NEAREST_MIPMAP_NEAREST,[Mr]:i.NEAREST_MIPMAP_LINEAR,[Mt]:i.LINEAR,[Ka]:i.LINEAR_MIPMAP_NEAREST,[hi]:i.LINEAR_MIPMAP_LINEAR},it={[Mg]:i.NEVER,[wg]:i.ALWAYS,[bg]:i.LESS,[xh]:i.LEQUAL,[Tg]:i.EQUAL,[vh]:i.GEQUAL,[Eg]:i.GREATER,[Ag]:i.NOTEQUAL};function Ge(E,S){if(S.type===vn&&e.has("OES_texture_float_linear")===!1&&(S.magFilter===Mt||S.magFilter===Ka||S.magFilter===Mr||S.magFilter===hi||S.minFilter===Mt||S.minFilter===Ka||S.minFilter===Mr||S.minFilter===hi)&&De("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(E,i.TEXTURE_WRAP_S,Ce[S.wrapS]),i.texParameteri(E,i.TEXTURE_WRAP_T,Ce[S.wrapT]),(E===i.TEXTURE_3D||E===i.TEXTURE_2D_ARRAY)&&i.texParameteri(E,i.TEXTURE_WRAP_R,Ce[S.wrapR]),i.texParameteri(E,i.TEXTURE_MAG_FILTER,Ke[S.magFilter]),i.texParameteri(E,i.TEXTURE_MIN_FILTER,Ke[S.minFilter]),S.compareFunction&&(i.texParameteri(E,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(E,i.TEXTURE_COMPARE_FUNC,it[S.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(S.magFilter===It||S.minFilter!==Mr&&S.minFilter!==hi||S.type===vn&&e.has("OES_texture_float_linear")===!1)return;if(S.anisotropy>1||n.get(S).__currentAnisotropy){const z=e.get("EXT_texture_filter_anisotropic");i.texParameterf(E,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,s.getMaxAnisotropy())),n.get(S).__currentAnisotropy=S.anisotropy}}}function D(E,S){let z=!1;E.__webglInit===void 0&&(E.__webglInit=!0,S.addEventListener("dispose",R));const J=S.source;let se=f.get(J);se===void 0&&(se={},f.set(J,se));const he=H(S);if(he!==E.__cacheKey){se[he]===void 0&&(se[he]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,z=!0),se[he].usedTimes++;const fe=se[E.__cacheKey];fe!==void 0&&(se[E.__cacheKey].usedTimes--,fe.usedTimes===0&&I(S)),E.__cacheKey=he,E.__webglTexture=se[he].texture}return z}function B(E,S,z){return Math.floor(Math.floor(E/z)/S)}function G(E,S,z,J){const he=E.updateRanges;if(he.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,S.width,S.height,z,J,S.data);else{he.sort((Ae,me)=>Ae.start-me.start);let fe=0;for(let Ae=1;Ae<he.length;Ae++){const me=he[fe],ue=he[Ae],Xe=me.start+me.count,$e=B(ue.start,S.width,4),ot=B(me.start,S.width,4);ue.start<=Xe+1&&$e===ot&&B(ue.start+ue.count-1,S.width,4)===$e?me.count=Math.max(me.count,ue.start+ue.count-me.start):(++fe,he[fe]=ue)}he.length=fe+1;const j=t.getParameter(i.UNPACK_ROW_LENGTH),Q=t.getParameter(i.UNPACK_SKIP_PIXELS),Me=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,S.width);for(let Ae=0,me=he.length;Ae<me;Ae++){const ue=he[Ae],Xe=Math.floor(ue.start/4),$e=Math.ceil(ue.count/4),ot=Xe%S.width,U=Math.floor(Xe/S.width),de=$e,Z=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,ot),t.pixelStorei(i.UNPACK_SKIP_ROWS,U),t.texSubImage2D(i.TEXTURE_2D,0,ot,U,de,Z,z,J,S.data)}E.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,j),t.pixelStorei(i.UNPACK_SKIP_PIXELS,Q),t.pixelStorei(i.UNPACK_SKIP_ROWS,Me)}}function Y(E,S,z){let J=i.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&(J=i.TEXTURE_2D_ARRAY),S.isData3DTexture&&(J=i.TEXTURE_3D);const se=D(E,S),he=S.source;t.bindTexture(J,E.__webglTexture,i.TEXTURE0+z);const fe=n.get(he);if(he.version!==fe.__version||se===!0){if(t.activeTexture(i.TEXTURE0+z),(typeof ImageBitmap<"u"&&S.image instanceof ImageBitmap)===!1){const Z=nt.getPrimaries(nt.workingColorSpace),be=S.colorSpace===Oi?null:nt.getPrimaries(S.colorSpace),ge=S.colorSpace===Oi||Z===be?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,S.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ge)}t.pixelStorei(i.UNPACK_ALIGNMENT,S.unpackAlignment);let Q=g(S.image,!1,s.maxTextureSize);Q=oe(S,Q);const Me=r.convert(S.format,S.colorSpace),Ae=r.convert(S.type);let me=v(S.internalFormat,Me,Ae,S.normalized,S.colorSpace,S.isVideoTexture);Ge(J,S);let ue;const Xe=S.mipmaps,$e=S.isVideoTexture!==!0,ot=fe.__version===void 0||se===!0,U=he.dataReady,de=T(S,Q);if(S.isDepthTexture)me=C(S.format===Ji,S.type),ot&&($e?t.texStorage2D(i.TEXTURE_2D,1,me,Q.width,Q.height):t.texImage2D(i.TEXTURE_2D,0,me,Q.width,Q.height,0,Me,Ae,null));else if(S.isDataTexture)if(Xe.length>0){$e&&ot&&t.texStorage2D(i.TEXTURE_2D,de,me,Xe[0].width,Xe[0].height);for(let Z=0,be=Xe.length;Z<be;Z++)ue=Xe[Z],$e?U&&t.texSubImage2D(i.TEXTURE_2D,Z,0,0,ue.width,ue.height,Me,Ae,ue.data):t.texImage2D(i.TEXTURE_2D,Z,me,ue.width,ue.height,0,Me,Ae,ue.data);S.generateMipmaps=!1}else $e?(ot&&t.texStorage2D(i.TEXTURE_2D,de,me,Q.width,Q.height),U&&G(S,Q,Me,Ae)):t.texImage2D(i.TEXTURE_2D,0,me,Q.width,Q.height,0,Me,Ae,Q.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){$e&&ot&&t.texStorage3D(i.TEXTURE_2D_ARRAY,de,me,Xe[0].width,Xe[0].height,Q.depth);for(let Z=0,be=Xe.length;Z<be;Z++)if(ue=Xe[Z],S.format!==yn)if(Me!==null)if($e){if(U)if(S.layerUpdates.size>0){const ge=$c(ue.width,ue.height,S.format,S.type);for(const re of S.layerUpdates){const Ne=ue.data.subarray(re*ge/ue.data.BYTES_PER_ELEMENT,(re+1)*ge/ue.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Z,0,0,re,ue.width,ue.height,1,Me,Ne)}S.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Z,0,0,0,ue.width,ue.height,Q.depth,Me,ue.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,Z,me,ue.width,ue.height,Q.depth,0,ue.data,0,0);else De("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else $e?U&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,Z,0,0,0,ue.width,ue.height,Q.depth,Me,Ae,ue.data):t.texImage3D(i.TEXTURE_2D_ARRAY,Z,me,ue.width,ue.height,Q.depth,0,Me,Ae,ue.data)}else{$e&&ot&&t.texStorage2D(i.TEXTURE_2D,de,me,Xe[0].width,Xe[0].height);for(let Z=0,be=Xe.length;Z<be;Z++)ue=Xe[Z],S.format!==yn?Me!==null?$e?U&&t.compressedTexSubImage2D(i.TEXTURE_2D,Z,0,0,ue.width,ue.height,Me,ue.data):t.compressedTexImage2D(i.TEXTURE_2D,Z,me,ue.width,ue.height,0,ue.data):De("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):$e?U&&t.texSubImage2D(i.TEXTURE_2D,Z,0,0,ue.width,ue.height,Me,Ae,ue.data):t.texImage2D(i.TEXTURE_2D,Z,me,ue.width,ue.height,0,Me,Ae,ue.data)}else if(S.isDataArrayTexture)if($e){if(ot&&t.texStorage3D(i.TEXTURE_2D_ARRAY,de,me,Q.width,Q.height,Q.depth),U)if(S.layerUpdates.size>0){const Z=$c(Q.width,Q.height,S.format,S.type);for(const be of S.layerUpdates){const ge=Q.data.subarray(be*Z/Q.data.BYTES_PER_ELEMENT,(be+1)*Z/Q.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,be,Q.width,Q.height,1,Me,Ae,ge)}S.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,Me,Ae,Q.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,me,Q.width,Q.height,Q.depth,0,Me,Ae,Q.data);else if(S.isData3DTexture)$e?(ot&&t.texStorage3D(i.TEXTURE_3D,de,me,Q.width,Q.height,Q.depth),U&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,Me,Ae,Q.data)):t.texImage3D(i.TEXTURE_3D,0,me,Q.width,Q.height,Q.depth,0,Me,Ae,Q.data);else if(S.isFramebufferTexture){if(ot)if($e)t.texStorage2D(i.TEXTURE_2D,de,me,Q.width,Q.height);else{let Z=Q.width,be=Q.height;for(let ge=0;ge<de;ge++)t.texImage2D(i.TEXTURE_2D,ge,me,Z,be,0,Me,Ae,null),Z>>=1,be>>=1}}else if(S.isHTMLTexture){if("texElementImage2D"in i){const Z=i.canvas;if(Z.hasAttribute("layoutsubtree")||Z.setAttribute("layoutsubtree","true"),Q.parentNode!==Z){Z.appendChild(Q),u.add(S),Z.onpaint=Ye=>{const Et=Ye.changedElements;for(const dt of u)Et.includes(dt.image)&&(dt.needsUpdate=!0)},Z.requestPaint();return}const be=0,ge=i.RGBA,re=i.RGBA,Ne=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,be,ge,re,Ne,Q),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Xe.length>0){if($e&&ot){const Z=at(Xe[0]);t.texStorage2D(i.TEXTURE_2D,de,me,Z.width,Z.height)}for(let Z=0,be=Xe.length;Z<be;Z++)ue=Xe[Z],$e?U&&t.texSubImage2D(i.TEXTURE_2D,Z,0,0,Me,Ae,ue):t.texImage2D(i.TEXTURE_2D,Z,me,Me,Ae,ue);S.generateMipmaps=!1}else if($e){if(ot){const Z=at(Q);t.texStorage2D(i.TEXTURE_2D,de,me,Z.width,Z.height)}U&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,Me,Ae,Q)}else t.texImage2D(i.TEXTURE_2D,0,me,Me,Ae,Q);m(S)&&y(J),fe.__version=he.version,S.onUpdate&&S.onUpdate(S)}E.__version=S.version}function ce(E,S,z){if(S.image.length!==6)return;const J=D(E,S),se=S.source;t.bindTexture(i.TEXTURE_CUBE_MAP,E.__webglTexture,i.TEXTURE0+z);const he=n.get(se);if(se.version!==he.__version||J===!0){t.activeTexture(i.TEXTURE0+z);const fe=nt.getPrimaries(nt.workingColorSpace),j=S.colorSpace===Oi?null:nt.getPrimaries(S.colorSpace),Q=S.colorSpace===Oi||fe===j?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,S.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,S.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Q);const Me=S.isCompressedTexture||S.image[0].isCompressedTexture,Ae=S.image[0]&&S.image[0].isDataTexture,me=[];for(let re=0;re<6;re++)!Me&&!Ae?me[re]=g(S.image[re],!0,s.maxCubemapSize):me[re]=Ae?S.image[re].image:S.image[re],me[re]=oe(S,me[re]);const ue=me[0],Xe=r.convert(S.format,S.colorSpace),$e=r.convert(S.type),ot=v(S.internalFormat,Xe,$e,S.normalized,S.colorSpace),U=S.isVideoTexture!==!0,de=he.__version===void 0||J===!0,Z=se.dataReady;let be=T(S,ue);Ge(i.TEXTURE_CUBE_MAP,S);let ge;if(Me){U&&de&&t.texStorage2D(i.TEXTURE_CUBE_MAP,be,ot,ue.width,ue.height);for(let re=0;re<6;re++){ge=me[re].mipmaps;for(let Ne=0;Ne<ge.length;Ne++){const Ye=ge[Ne];S.format!==yn?Xe!==null?U?Z&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+re,Ne,0,0,Ye.width,Ye.height,Xe,Ye.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+re,Ne,ot,Ye.width,Ye.height,0,Ye.data):De("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):U?Z&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+re,Ne,0,0,Ye.width,Ye.height,Xe,$e,Ye.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+re,Ne,ot,Ye.width,Ye.height,0,Xe,$e,Ye.data)}}}else{if(ge=S.mipmaps,U&&de){ge.length>0&&be++;const re=at(me[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,be,ot,re.width,re.height)}for(let re=0;re<6;re++)if(Ae){U?Z&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+re,0,0,0,me[re].width,me[re].height,Xe,$e,me[re].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+re,0,ot,me[re].width,me[re].height,0,Xe,$e,me[re].data);for(let Ne=0;Ne<ge.length;Ne++){const Et=ge[Ne].image[re].image;U?Z&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+re,Ne+1,0,0,Et.width,Et.height,Xe,$e,Et.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+re,Ne+1,ot,Et.width,Et.height,0,Xe,$e,Et.data)}}else{U?Z&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+re,0,0,0,Xe,$e,me[re]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+re,0,ot,Xe,$e,me[re]);for(let Ne=0;Ne<ge.length;Ne++){const Ye=ge[Ne];U?Z&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+re,Ne+1,0,0,Xe,$e,Ye.image[re]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+re,Ne+1,ot,Xe,$e,Ye.image[re])}}}m(S)&&y(i.TEXTURE_CUBE_MAP),he.__version=se.version,S.onUpdate&&S.onUpdate(S)}E.__version=S.version}function Re(E,S,z,J,se,he){const fe=r.convert(z.format,z.colorSpace),j=r.convert(z.type),Q=v(z.internalFormat,fe,j,z.normalized,z.colorSpace),Me=n.get(S),Ae=n.get(z);if(Ae.__renderTarget=S,!Me.__hasExternalTextures){const me=Math.max(1,S.width>>he),ue=Math.max(1,S.height>>he);se===i.TEXTURE_3D||se===i.TEXTURE_2D_ARRAY?t.texImage3D(se,he,Q,me,ue,S.depth,0,fe,j,null):t.texImage2D(se,he,Q,me,ue,0,fe,j,null)}t.bindFramebuffer(i.FRAMEBUFFER,E),Le(S)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,J,se,Ae.__webglTexture,0,We(S)):(se===i.TEXTURE_2D||se>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&se<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,J,se,Ae.__webglTexture,he),t.bindFramebuffer(i.FRAMEBUFFER,null)}function ze(E,S,z){if(i.bindRenderbuffer(i.RENDERBUFFER,E),S.depthBuffer){const J=S.depthTexture,se=J&&J.isDepthTexture?J.type:null,he=C(S.stencilBuffer,se),fe=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;Le(S)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,We(S),he,S.width,S.height):z?i.renderbufferStorageMultisample(i.RENDERBUFFER,We(S),he,S.width,S.height):i.renderbufferStorage(i.RENDERBUFFER,he,S.width,S.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,fe,i.RENDERBUFFER,E)}else{const J=S.textures;for(let se=0;se<J.length;se++){const he=J[se],fe=r.convert(he.format,he.colorSpace),j=r.convert(he.type),Q=v(he.internalFormat,fe,j,he.normalized,he.colorSpace);Le(S)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,We(S),Q,S.width,S.height):z?i.renderbufferStorageMultisample(i.RENDERBUFFER,We(S),Q,S.width,S.height):i.renderbufferStorage(i.RENDERBUFFER,Q,S.width,S.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Pe(E,S,z){const J=S.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,E),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const se=n.get(S.depthTexture);if(se.__renderTarget=S,(!se.__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),J){if(se.__webglInit===void 0&&(se.__webglInit=!0,S.depthTexture.addEventListener("dispose",R)),se.__webglTexture===void 0){se.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,se.__webglTexture),Ge(i.TEXTURE_CUBE_MAP,S.depthTexture);const Me=r.convert(S.depthTexture.format),Ae=r.convert(S.depthTexture.type);let me;S.depthTexture.format===vi?me=i.DEPTH_COMPONENT24:S.depthTexture.format===Ji&&(me=i.DEPTH24_STENCIL8);for(let ue=0;ue<6;ue++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0,me,S.width,S.height,0,Me,Ae,null)}}else ne(S.depthTexture,0);const he=se.__webglTexture,fe=We(S),j=J?i.TEXTURE_CUBE_MAP_POSITIVE_X+z:i.TEXTURE_2D,Q=S.depthTexture.format===Ji?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(S.depthTexture.format===vi)Le(S)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Q,j,he,0,fe):i.framebufferTexture2D(i.FRAMEBUFFER,Q,j,he,0);else if(S.depthTexture.format===Ji)Le(S)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Q,j,he,0,fe):i.framebufferTexture2D(i.FRAMEBUFFER,Q,j,he,0);else throw new Error("Unknown depthTexture format")}function $(E){const S=n.get(E),z=E.isWebGLCubeRenderTarget===!0;if(S.__boundDepthTexture!==E.depthTexture){const J=E.depthTexture;if(S.__depthDisposeCallback&&S.__depthDisposeCallback(),J){const se=()=>{delete S.__boundDepthTexture,delete S.__depthDisposeCallback,J.removeEventListener("dispose",se)};J.addEventListener("dispose",se),S.__depthDisposeCallback=se}S.__boundDepthTexture=J}if(E.depthTexture&&!S.__autoAllocateDepthBuffer)if(z)for(let J=0;J<6;J++)Pe(S.__webglFramebuffer[J],E,J);else{const J=E.texture.mipmaps;J&&J.length>0?Pe(S.__webglFramebuffer[0],E,0):Pe(S.__webglFramebuffer,E,0)}else if(z){S.__webglDepthbuffer=[];for(let J=0;J<6;J++)if(t.bindFramebuffer(i.FRAMEBUFFER,S.__webglFramebuffer[J]),S.__webglDepthbuffer[J]===void 0)S.__webglDepthbuffer[J]=i.createRenderbuffer(),ze(S.__webglDepthbuffer[J],E,!1);else{const se=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,he=S.__webglDepthbuffer[J];i.bindRenderbuffer(i.RENDERBUFFER,he),i.framebufferRenderbuffer(i.FRAMEBUFFER,se,i.RENDERBUFFER,he)}}else{const J=E.texture.mipmaps;if(J&&J.length>0?t.bindFramebuffer(i.FRAMEBUFFER,S.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer===void 0)S.__webglDepthbuffer=i.createRenderbuffer(),ze(S.__webglDepthbuffer,E,!1);else{const se=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,he=S.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,he),i.framebufferRenderbuffer(i.FRAMEBUFFER,se,i.RENDERBUFFER,he)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function te(E,S,z){const J=n.get(E);S!==void 0&&Re(J.__webglFramebuffer,E,E.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),z!==void 0&&$(E)}function ee(E){const S=E.texture,z=n.get(E),J=n.get(S);E.addEventListener("dispose",x);const se=E.textures,he=E.isWebGLCubeRenderTarget===!0,fe=se.length>1;if(fe||(J.__webglTexture===void 0&&(J.__webglTexture=i.createTexture()),J.__version=S.version,a.memory.textures++),he){z.__webglFramebuffer=[];for(let j=0;j<6;j++)if(S.mipmaps&&S.mipmaps.length>0){z.__webglFramebuffer[j]=[];for(let Q=0;Q<S.mipmaps.length;Q++)z.__webglFramebuffer[j][Q]=i.createFramebuffer()}else z.__webglFramebuffer[j]=i.createFramebuffer()}else{if(S.mipmaps&&S.mipmaps.length>0){z.__webglFramebuffer=[];for(let j=0;j<S.mipmaps.length;j++)z.__webglFramebuffer[j]=i.createFramebuffer()}else z.__webglFramebuffer=i.createFramebuffer();if(fe)for(let j=0,Q=se.length;j<Q;j++){const Me=n.get(se[j]);Me.__webglTexture===void 0&&(Me.__webglTexture=i.createTexture(),a.memory.textures++)}if(E.samples>0&&Le(E)===!1){z.__webglMultisampledFramebuffer=i.createFramebuffer(),z.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let j=0;j<se.length;j++){const Q=se[j];z.__webglColorRenderbuffer[j]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,z.__webglColorRenderbuffer[j]);const Me=r.convert(Q.format,Q.colorSpace),Ae=r.convert(Q.type),me=v(Q.internalFormat,Me,Ae,Q.normalized,Q.colorSpace,E.isXRRenderTarget===!0),ue=We(E);i.renderbufferStorageMultisample(i.RENDERBUFFER,ue,me,E.width,E.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+j,i.RENDERBUFFER,z.__webglColorRenderbuffer[j])}i.bindRenderbuffer(i.RENDERBUFFER,null),E.depthBuffer&&(z.__webglDepthRenderbuffer=i.createRenderbuffer(),ze(z.__webglDepthRenderbuffer,E,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(he){t.bindTexture(i.TEXTURE_CUBE_MAP,J.__webglTexture),Ge(i.TEXTURE_CUBE_MAP,S);for(let j=0;j<6;j++)if(S.mipmaps&&S.mipmaps.length>0)for(let Q=0;Q<S.mipmaps.length;Q++)Re(z.__webglFramebuffer[j][Q],E,S,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Q);else Re(z.__webglFramebuffer[j],E,S,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0);m(S)&&y(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(fe){for(let j=0,Q=se.length;j<Q;j++){const Me=se[j],Ae=n.get(Me);let me=i.TEXTURE_2D;(E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(me=E.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(me,Ae.__webglTexture),Ge(me,Me),Re(z.__webglFramebuffer,E,Me,i.COLOR_ATTACHMENT0+j,me,0),m(Me)&&y(me)}t.unbindTexture()}else{let j=i.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(j=E.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(j,J.__webglTexture),Ge(j,S),S.mipmaps&&S.mipmaps.length>0)for(let Q=0;Q<S.mipmaps.length;Q++)Re(z.__webglFramebuffer[Q],E,S,i.COLOR_ATTACHMENT0,j,Q);else Re(z.__webglFramebuffer,E,S,i.COLOR_ATTACHMENT0,j,0);m(S)&&y(j),t.unbindTexture()}E.depthBuffer&&$(E)}function pe(E){const S=E.textures;for(let z=0,J=S.length;z<J;z++){const se=S[z];if(m(se)){const he=M(E),fe=n.get(se).__webglTexture;t.bindTexture(he,fe),y(he),t.unbindTexture()}}}const le=[],Fe=[];function L(E){if(E.samples>0){if(Le(E)===!1){const S=E.textures,z=E.width,J=E.height;let se=i.COLOR_BUFFER_BIT;const he=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,fe=n.get(E),j=S.length>1;if(j)for(let Me=0;Me<S.length;Me++)t.bindFramebuffer(i.FRAMEBUFFER,fe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Me,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,fe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Me,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,fe.__webglMultisampledFramebuffer);const Q=E.texture.mipmaps;Q&&Q.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,fe.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,fe.__webglFramebuffer);for(let Me=0;Me<S.length;Me++){if(E.resolveDepthBuffer&&(E.depthBuffer&&(se|=i.DEPTH_BUFFER_BIT),E.stencilBuffer&&E.resolveStencilBuffer&&(se|=i.STENCIL_BUFFER_BIT)),j){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,fe.__webglColorRenderbuffer[Me]);const Ae=n.get(S[Me]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Ae,0)}i.blitFramebuffer(0,0,z,J,0,0,z,J,se,i.NEAREST),l===!0&&(le.length=0,Fe.length=0,le.push(i.COLOR_ATTACHMENT0+Me),E.depthBuffer&&E.resolveDepthBuffer===!1&&(le.push(he),Fe.push(he),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Fe)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,le))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),j)for(let Me=0;Me<S.length;Me++){t.bindFramebuffer(i.FRAMEBUFFER,fe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Me,i.RENDERBUFFER,fe.__webglColorRenderbuffer[Me]);const Ae=n.get(S[Me]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,fe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Me,i.TEXTURE_2D,Ae,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,fe.__webglMultisampledFramebuffer)}else if(E.depthBuffer&&E.resolveDepthBuffer===!1&&l){const S=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[S])}}}function We(E){return Math.min(s.maxSamples,E.samples)}function Le(E){const S=n.get(E);return E.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function Ve(E){const S=a.render.frame;h.get(E)!==S&&(h.set(E,S),E.update())}function oe(E,S){const z=E.colorSpace,J=E.format,se=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||z!==cn&&z!==Oi&&(nt.getTransfer(z)===ct?(J!==yn||se!==ln)&&De("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Be("WebGLTextures: Unsupported texture color space:",z)),S}function at(E){return typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement?(c.width=E.naturalWidth||E.width,c.height=E.naturalHeight||E.height):typeof VideoFrame<"u"&&E instanceof VideoFrame?(c.width=E.displayWidth,c.height=E.displayHeight):(c.width=E.width,c.height=E.height),c}this.allocateTextureUnit=V,this.resetTextureUnits=q,this.getTextureUnits=F,this.setTextureUnits=N,this.setTexture2D=ne,this.setTexture2DArray=ae,this.setTexture3D=_e,this.setTextureCube=ve,this.rebindTextures=te,this.setupRenderTarget=ee,this.updateRenderTargetMipmap=pe,this.updateMultisampleRenderTarget=L,this.setupDepthRenderbuffer=$,this.setupFrameBufferTexture=Re,this.useMultisampledRTT=Le,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function DM(i,e){function t(n,s=Oi){let r;const a=nt.getTransfer(s);if(n===ln)return i.UNSIGNED_BYTE;if(n===dh)return i.UNSIGNED_SHORT_4_4_4_4;if(n===fh)return i.UNSIGNED_SHORT_5_5_5_1;if(n===$f)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Zf)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Yf)return i.BYTE;if(n===jf)return i.SHORT;if(n===Ir)return i.UNSIGNED_SHORT;if(n===uh)return i.INT;if(n===Yn)return i.UNSIGNED_INT;if(n===vn)return i.FLOAT;if(n===xi)return i.HALF_FLOAT;if(n===Jf)return i.ALPHA;if(n===Qf)return i.RGB;if(n===yn)return i.RGBA;if(n===vi)return i.DEPTH_COMPONENT;if(n===Ji)return i.DEPTH_STENCIL;if(n===ph)return i.RED;if(n===mh)return i.RED_INTEGER;if(n===ns)return i.RG;if(n===gh)return i.RG_INTEGER;if(n===_h)return i.RGBA_INTEGER;if(n===Ya||n===ja||n===$a||n===Za)if(a===ct)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Ya)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===ja)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===$a)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Za)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Ya)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===ja)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===$a)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Za)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===cc||n===hc||n===uc||n===dc)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===cc)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===hc)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===uc)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===dc)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===fc||n===pc||n===mc||n===gc||n===_c||n===no||n===xc)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===fc||n===pc)return a===ct?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===mc)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===gc)return r.COMPRESSED_R11_EAC;if(n===_c)return r.COMPRESSED_SIGNED_R11_EAC;if(n===no)return r.COMPRESSED_RG11_EAC;if(n===xc)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===vc||n===yc||n===Sc||n===Mc||n===bc||n===Tc||n===Ec||n===Ac||n===wc||n===Rc||n===Cc||n===Pc||n===Lc||n===Dc)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===vc)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===yc)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Sc)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Mc)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===bc)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Tc)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Ec)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Ac)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===wc)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Rc)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Cc)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Pc)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Lc)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Dc)return a===ct?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Ic||n===Nc||n===Uc)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Ic)return a===ct?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Nc)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Uc)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Oc||n===Fc||n===io||n===Bc)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Oc)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Fc)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===io)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Bc)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Nr?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const IM=`
void main() {
